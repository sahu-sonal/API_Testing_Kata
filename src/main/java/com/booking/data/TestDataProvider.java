...
public class TestDataProvider {
    ...
    public Object[][] createBookingPositiveCaseData() {
        return new Object[][]{
                ...
                {2,"Siva","Kumari",true,"test1@gmail.com","24433234324",500,"Validate Duplicate Create Booking"}
        };
    }
    ...
    public Object[][] createBookingNegativeCaseData() {
        return new Object[][]{
                ...
                {201,"Siv","Kumari",true,"test1@gmail.com","24433234324",200,null,"Validate Error Msg - FirstName is of size 3"},
                {401,"SivakumariTestTest","Kumari",true,"test1@gmail.com","24433234324",200,null,"Validate Error Msg - FirstName is of size 18"},
                ...
                {101,"Siva","Kum",true,"test1@gmail.com","24433234324",200,null,"Validate Error Msg - LastName is of size 3"},
                {301,"Siva","KumariKumariKumariKumariKumari",true,"test1@gmail.com","24433234324",200,null,"Validate Error Msg - LastName is of size 30"},
                ...
                {4,"Siva","Kumari",true,"test1@gmail.com","44332343244",200,null,"Validate Error Msg - Phone Value size is 11"},
                {1,"Siva","Kumari",true,"test1@gmail.com","443323432444343536354",200,null,"Validate Error Msg - Phone Value size is 21"},
    ...
    public Object[][] createBookingDatesNegativeCaseData() {
        return new Object[][]{
                ...
                {"2025/12/01", "2025-12-02",400, Arrays.asList("Failed to create booking"), "Validate Error Msg - Checkin Date is format pattern is wrong"},
                {"2025-12-01", "2025/12/02",400, Arrays.asList("Failed to create booking"), "Validate Error Msg - CheckOut Date is format pattern is wrong"},
